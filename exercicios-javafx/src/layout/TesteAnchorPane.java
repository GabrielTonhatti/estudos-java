...
public class TesteAnchorPane extends AnchorPane {
	...
	public TesteAnchorPane() {
		...
		setTopAnchor(q2, 10.0); // Fica 10px de distância do topo
		setRightAnchor(q2, 10.0); // Fica 10px de distância da ponta direita

		Quadrado q3 = new Quadrado();
		setBottomAnchor(q3, 10.0); // Fica 10px de distância da parte de baixo
		setLeftAnchor(q3, 10.0); // Fica 10px de distância da ponta esquerda
